	...
	if year == "2000":
		...
		for row in cr:
			...
			if flag == "0":
				...
				data[fips][year]["usdaOff_hudOnNum"] = row[indices["Units"]]
				...
				data[fips][year]["usdaOff_hudOn"] = row[indices["ST_per100"]]
				...
				data[fips][year]["usdaOff_hudOnNum"] = row[indices["ST_Units"]]
